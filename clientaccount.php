...
<head>
  ...
  <!-- Custom Theme CSS -->
  <link href="css/clientaccount.css" rel="stylesheet">
</head>
...
$temp2=-1;
    ...
    $q3=mysqli_query($con,"select * from campaignactivities where Clientid='$id2' order by campaignid ASC");
  ...
  $num;
    ...
    echo "<br>";
    $q5=mysqli_query($con,"select * from campaigns where Clientid='$id2' order by campaignid DESC");
        $row5=mysqli_fetch_assoc($q5);
        $camploc=$row5['campaignlocation'];
        $campdesc=$row5['campaigndescription'];
        $campdate=$row5['eventroughdates'];
        $campnotif=$row5['Clientnotification'];
        $num=$row5['numactivities'];
    ...
    {  // var_dump($temp2);
        ...
        $campnotif=$row4['Clientnotification'];
        $num=$row4['numactivities'];
        //var_dump($num);
        echo "<br>"; 
        //if (count(glob('campaignpics/'.$v.'/*.{jpg,png,gif}', GLOB_BRACE))>0)
...
<tr>";
    ...
    {  
       ...
       // echo "<div class='clientres2'> Previous input:";
        ...
        $a=0;
        if ($cliente[2]!="") $a=5;
        else if ($clientd[2]!="") $a=4;
        else if ($clientc[2]!="") $a=3;
        else if ($clientb[2]!="") $a=2;
        else if ($clienta[2]!="") $a=1;
       // echo "</div>";
    ...
    <div>    
        ...
        if ($ambe[3]!="") echo "<td>".$ambe[4]."</td>";
        else if ($ambd[3]!="") echo "<td>".$ambd[4]."</td>";
        else if ($ambc[3]!="") echo "<td>".$ambc[4]."</td>";
        else if ($ambb[3]!="") echo "<td>".$ambb[4]."</td>";
        else if ($amba[3]!="") echo "<td>".$amba[4]."</td>";
        else echo "<td>".""."</td>";
    }
}
...
<?php
        $q11=mysqli_query($con,"select * from clientusers where Clientemail='".$_SESSION["Email"]."'");
        $row11=mysqli_fetch_assoc($q11);
        $id11=$row11['Clientid'];
        
        $q12=mysqli_query($con,"select * from campaigns where Clientid!='$id11' order by eventstartdate DESC ");
...
<?php
    ...
    <script src="js/clientaccount.js">
    </script>
